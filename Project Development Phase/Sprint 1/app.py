...
#         sql="INSERT INTO new (EMAIL,PASSWORD) VALUES(?,?)"
...
# app.config['uid'] = 'lsc91268'
# app.config['pwd'] = 'dlWyz6qJK3v27xP6'
...
def login():
    ...
    if request.method == 'POST' :
        ...
        if account:
            ...
            # session['name'] = dictionary["USERNAME"]
